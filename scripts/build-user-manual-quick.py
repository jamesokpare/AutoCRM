...
FEATURES = [
    ...
    ("My tasks", "/tasks",
     ["Assign yourself a task — title + priority + day.",
      "Update status from the card.",
      "Last week's open items carry over automatically."]),
    ("Team board", "/team",
     ["List or Kanban view.",
      "Assign a task to anyone on the team from the Add task form.",
      "Filter by person, status, priority.",
      "Drag cards on Kanban to change status."]),
    ("Peer reviews", "/reviews",
     ["Cycle-based — review one another's work each cycle.",
      "Score peers on Deliverables (delivery of work) and Communication (1–5 stars).",
